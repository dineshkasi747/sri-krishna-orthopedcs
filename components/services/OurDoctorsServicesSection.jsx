...
export default function OurDoctorsServicesSection() {
  const sectionRef = useScrollAnimation();

  const doctors = [
    {
      image: "/services/JPG/team-1.jpg",
